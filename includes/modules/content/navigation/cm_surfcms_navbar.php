...
*/
  ...
  class cm_surfcms_navbar {
    ...
    function keys() {
      return array('MODULE_CONTENT_SURFCMS_NAVBAR_STATUS', 'MODULE_CONTENT_SURFCMS_NAVBAR_STYLE', 'MODULE_CONTENT_SURFCMS_NAVBAR_CORNERS', 'MODULE_CONTENT_SURFCMS_NAVBAR_MARGIN', 'MODULE_CONTENT_SURFCMS_NAVBAR_FIXED', 'MODULE_CONTENT_SURFCMS_NAVBAR_SORT_ORDER');
    }
  }
